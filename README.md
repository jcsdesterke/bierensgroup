...
Biri uses Firebase Realtime Database to write and read user data. In order to use this method you need to define your own database. The steps you need to take to succesfully do this are explained in [this video](https://www.youtube.com/watch?v=3cAKH-9_mHA).
