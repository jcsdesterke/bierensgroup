...
We have set up our file structure in a proper way to make to project easy to access. Below I will tell you more about certain files and their use. The best way to prevent errors is by copying the example pages. This way all the scripts are imported right and in the right order.
...
#### monitor.js
In this file we read all the user data from the database and display it in a clean monitor. This way you can easily see the data that is being collected and the data that has been analysed already.
...
#### multiplier.js
In this file a lot of calculation is done. We use different data sources to calculate the conversion rate and other interessting values. The best way to understand this file is by reading the comments within the file.
